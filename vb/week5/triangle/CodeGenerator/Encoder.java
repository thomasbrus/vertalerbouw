...
public final class Encoder implements Visitor {
	...
	public Object visitCaseCommand(CaseCommand ast, Object o) {
		Frame frame = (Frame) o;
		CaseBranchArgument arg = new CaseBranchArgument(frame, ast.E);
		int jumpifAddr, jumpAddr;
	

		List<Integer> jumpList = (List<Integer>) ast.CB.visit(this, arg);

		ast.C.visit(this, frame);
		
		jumpifAddr = nextInstrAddr;

		for (Integer i : jumpList) {
			patch(i, jumpifAddr);
		}
	...
	public Object visitCaseBranch(CaseBranch ast, Object o) {
		if (ast instanceof MultipleCaseBranch) {
			return visitMultipleCaseBranch((MultipleCaseBranch) ast, o);
		}
		if (ast instanceof SingleCaseBranch) {
			return visitSingleCaseBranch((SingleCaseBranch) ast, o);
		}
		return null;
	}

	public Object visitMultipleCaseBranch(MultipleCaseBranch ast, Object o) {
		CaseBranchArgument arg = (CaseBranchArgument)o;
		Frame frame = arg.frame;		
		int jumpifAddr, jumpAddr;
		
		Integer valSize = (Integer) arg.expr.visit(this, frame);
	...
	public Object visitVarFormalParameter(VarFormalParameter ast, Object o) {
		Frame frame = (Frame) o;
		// int valSize = ((Integer) ast.T.visit(this, null)).intValue();
		int valSize = 1; // [2003.03.15 ruys] should be the size of an absolute
							// address
	...
	public Object visitFuncActualParameter(FuncActualParameter ast, Object o) {
		...
		if (ast.I.decl.entity instanceof KnownRoutine) {
			...
			emit(Machine.LOADop, Machine.closureSize,
	...
	private void encodeStore(Vname V, Frame frame, int valSize) {
		...
		if (baseObject instanceof KnownAddress) {
			...
			emit(Machine.LOADop, Machine.addressSize,
					displayRegister(frame.level, address.level),
					address.displacement);
			if (V.indexed)
				emit(Machine.CALLop, Machine.SBr, Machine.PBr,
	...
	public class CaseBranchArgument {
		public Frame frame;
		public Expression expr;
		public CaseBranchArgument(Frame frame,Expression expr ){ this.frame = frame; this.expr = expr; }
